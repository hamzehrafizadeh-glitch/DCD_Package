...
If[TS==1,
SrrFinalt[xTemp_,yTemp_,i_]:=-50/(xTemp^2+yTemp^2);
SrrFinal[xTemp_,yTemp_,i_]:=SigmarrQ[i,TStart,TEnd,ThermalExpansion0,ThermalExpansionQ[i],xTemp,yTemp];
...
xxt=xx-Re[zcenter[i]];yyt=yy-Im[zcenter[i]];
r]

...
AppendTo[$Path,FileNameJoin[{FilePathPrivet1, "mFiles"}]];
...
Eta1[n_,m_,p_,q_]:=Module[{f1},f1=If[Abs[zpq[p,q]]>=Abs[ltest],EtaIntgPQ[n,m,p,q],EtaIntgPQ[n,m,p,q]]]
...
Mu1[n_,m_,p_,q_]:=Module[{f1},f1=If[Abs[zpq[p,q]]>=Abs[ltest],MuIntgPQ[n,m,p,q],MuIntgPQ[n,m,p,q]]]

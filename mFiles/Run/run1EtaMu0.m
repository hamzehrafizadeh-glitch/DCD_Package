...
BeginPackage["run1EtaMu0`"]
Unprotect@@Names["run1EtaMu0`*"];
ClearAll@@Names["run1EtaMu0`*"];
...
OutputfinalFile = FileNameJoin[{FilePath, "output", "outputfinal"}];
CopyFile[OutputfinalFile,OutputFile]
...
End[] 
Protect@@Names["run1EtaMu0`*"]
EndPackage[] 

BeginPackage["run1EtaMu0`",{"geometry`", "ExpansionCoefficient`" , "abmnpq`" , "matrix`" , "farfield`" ,"linearSolve`", "PhiPsi`","StressFields`","DisplacementFields`","SIF`"}] 
EndPackage[] 

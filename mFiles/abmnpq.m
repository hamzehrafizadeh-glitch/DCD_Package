...
dminus::usage=" dminus[i,q] To have a better understanding of the coefficient amnpq and bmnpq, please refer to ESA report. a and b reffers to the coefficients of the harmonic \!\(\*SuperscriptBox[\(v\), \(-n\)]\) and \!\(\*SuperscriptBox[\(v\), \(n\)]\) terms respectively. "; 
...
dminus[i_,q_]:=Module[{f},f=d[i,q]-2 i Sinh[2*Zeta0[q]] c[i,q]]
